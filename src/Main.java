public class Main {
    public static void main(String[] args) {
        Cars granta = new Cars(null,"Granta",1.7,null,2015,"России");
        ...
        Cars audi = new Cars("Audi", "A8 50 L TDI quattro",0,"Германии",2020,"Германии");
        ...
        Cars bmw = new Cars("BMW","Z8",3.0,"черного",2021,"Германии");
        ...
        Cars kia = new Cars("Kia","Sportage 4-го поколения",2.4,"красного",-2018, "Южной Корее");
        ...
        Cars hunday = new Cars("Hyundai",null,1.6,null,2018,"Южной Корее");
